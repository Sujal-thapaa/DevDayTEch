...
import { AlertTriangle, Eye, EyeOff, Shield, MapPin } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto py-8 px-6">
        <div className="flex items-center justify-center h-96 bg-gray-100 rounded-lg">
          <div className="text-center">
            ...
            <p className="text-gray-600">Loading Safety Alert Map...</p>
          </div>
        </div>
      </div>
    );
    ...
    <div className="max-w-7xl mx-auto py-8 px-6 space-y-8">
      ...
      <div className="text-center mb-8">
        <div className="flex items-center justify-center gap-3 mb-4">
          ...
          <h1 className="text-4xl font-bold text-gray-900">Safety Alert System</h1>
        </div>
        <p className="text-lg text-gray-600 max-w-3xl mx-auto">
          Monitor CO₂ storage facilities and water resources for contamination risks across Louisiana
        </p>
      </div>
      ...
      <Card className="p-6">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-2xl font-bold text-gray-900 flex items-center gap-2">
            ...
            Contamination Risk Assessment Map
          </h2>
          <div className="flex gap-3 items-center text-sm">
            <div className="flex items-center gap-1">
              <span className="w-4 h-4 rounded-sm bg-[#ff6b6b] border-2 border-[#ff6b6b] opacity-30"></span>
        ...
        <div className="mt-4 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h3 className="font-semibold text-yellow-800 mb-1">Safety Monitoring</h3>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <Card className="p-6">
          <h2 className="text-xl font-bold text-gray-900 mb-4">Risk Assessment Formula</h2>
          <div className="space-y-4">
            <div className="p-4 bg-gray-50 rounded-lg">
              <h3 className="font-semibold text-gray-900 mb-2">Risk Calculation</h3>
              <p className="text-sm text-gray-600 mb-2">
                Risk Score = (Age ÷ 20) + (Maintenance Cost ÷ 500,000) + Disaster Risk
              </p>
              <div className="text-xs text-gray-500">
                <p>• Age: Years since facility construction</p>
                <p>• Maintenance Cost: Annual maintenance spending</p>
                <p>• Disaster Risk: Natural disaster vulnerability (0-1)</p>
                <p>• High Risk Threshold: Score &gt; 1.5</p>
              </div>
            </div>
            <div className="p-4 bg-red-50 rounded-lg">
              <h3 className="font-semibold text-red-800 mb-2">High Risk Indicators</h3>
              <ul className="text-sm text-red-700 space-y-1">
                <li>• Facilities older than 15 years</li>
                <li>• High maintenance costs (&gt;$400K/year)</li>
                <li>• Located in hurricane/flood zones</li>
                <li>• Proximity to critical water sources</li>
              </ul>
            </div>
          </div>
        </Card>
        ...
        <Card className="p-6">
          <h2 className="text-xl font-bold text-gray-900 mb-4">Safety Measures</h2>
          <div className="space-y-4">
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Real-time monitoring of CO₂ storage facilities and surrounding water resources
                </p>
              </div>
            </div>
            <div className="flex gap-4">
            ...
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="font-semibold text-gray-900 mb-1">Early Warning</h3>
                <p className="text-sm text-gray-600">
                  Immediate alerts for high-risk zones and potential contamination threats
                </p>
              </div>
            </div>
          </div>
